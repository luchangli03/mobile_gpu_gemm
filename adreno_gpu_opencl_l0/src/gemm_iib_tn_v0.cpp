...
#pragma unroll
    for (int i = 0; i < KTILE; i++) {
      DTYPE_PACK4 b = READ_IMAGE_FUNC(img_b, (int2)(gx, kpos + i));
      DTYPE_PACK4 a0 = READ_IMAGE_FUNC(img_a, (int2)(a_x_off, kpos + i));
      DTYPE_PACK4 a1 = READ_IMAGE_FUNC(img_a, (int2)(a_x_off+1, kpos + i));
      c[0] = mad(a0.s0, b, c[0]);
      c[1] = mad(a0.s1, b, c[1]);
      c[2] = mad(a0.s2, b, c[2]);
      c[3] = mad(a0.s3, b, c[3]);
